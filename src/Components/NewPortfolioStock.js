        ...
        <form onSubmit={this.handleFormSubmit}>
          ...
          <label>
            ...
            <input
              type="text"
              disabled
              value={this.props.currentStock.symbol}
            />
            Company Name
            <input
              type="text"
              disabled
              value={this.props.currentStock.companyName}
            />
            Sector
            <input
              type="text"
              disabled
              value={this.props.currentStock.sector}
            />
            Price Change
            <input
              type="text"
              disabled
              value={this.props.currentStock.priceChange}
            />
            Price Change Percent
            <input
              type="text"
              disabled
              value={this.props.currentStock.priceChangePercent}
            />
            Price
            ...
            <input
              type="text"
              disabled
              value={this.props.currentStock.week52High}
            />
